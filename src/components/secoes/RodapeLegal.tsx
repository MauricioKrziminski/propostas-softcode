...
export function RodapeLegal({
  ...
  return (
    /* O rodapé é a ÚLTIMA SEÇÃO, e só isso: fluxo normal, sem cortina, sem
       gesto, sem nada. Ele não sobe por cima de ninguém, não é descoberto e não
       fica grudado na tela. A proposta termina no aceite e ele vem depois,
       igual a qualquer rodapé de site.

       `relative z-0` e `bg-fundo` continuam, e não são efeito: os capítulos são
       posicionados em `z-0`, então um rodapé em fluxo puro pintaria ATRÁS deles
       se um dia voltassem a se sobrepor, e transparente ele deixaria o escuro
       aparecer por trás do texto de tema claro. É seguro barato, e o fundo mora
       na casca porque na faixa de leitura (`max-w-6xl`) sobrariam duas tiras
       nas laterais. */
