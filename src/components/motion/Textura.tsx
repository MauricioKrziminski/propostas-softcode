 ...
 *
 * Um feTurbulence em data URI, em opacidade baixíssima: nenhuma requisição,
 * nenhum PNG no bundle, e o quase-preto deixa de parecer cor chapada.
 *
 * A separação entre seções NÃO depende disto — quem faz o trabalho é a
 * alternância de fundo e o divisor de ondas. Isto é só a textura por cima.
 */
const GRAO =
